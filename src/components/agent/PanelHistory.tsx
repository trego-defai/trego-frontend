    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-border bg-muted/30">
        ...
        <button
          ...
          className="text-muted-foreground hover:text-foreground text-sm hover:bg-muted rounded px-2 py-1 transition-colors"
        >
          + New
        </button>
      </div>
          ...
          <div className="p-2">
            {conversations.map((conversation) => (
              <div
                ...
                className={cn(
                  "p-3 rounded-lg cursor-pointer border transition-colors hover:bg-muted/50 mb-2 group",
