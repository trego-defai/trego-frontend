...
function SidebarItem({ icon, label, id, href, isActive, onClick }: SidebarItemProps) {
    ...
    <div className="w-16 bg-gradient-to-b from-slate-900 via-slate-950 to-black border-r border-slate-800/40 flex flex-col items-center pt-4 pb-6 shadow-2xl">
      ...
      <div className="flex flex-col space-y-3 flex-1">
        ...
        <SidebarItem
          ...
          onClick={() => handleNavigation('welcome', '/welcome')}
          icon={
        ...
        <SidebarItem
          ...
          onClick={() => handleNavigation('trading', '/trading')}
          icon={
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <SidebarItem
          ...
          onClick={() => handleNavigation('agent', '/agent')}
          icon={
